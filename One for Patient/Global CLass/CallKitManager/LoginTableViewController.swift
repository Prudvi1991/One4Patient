        ...
        QBChat.instance.connect(withUserID: user.id,
                                ...
                                completion: { [weak self] error in
                                    if let error = error {
                                        ...
                                        //did Login action
                                        let mainStoryboard: UIStoryboard = UIStoryboard(name: "Users", bundle: nil)
                                                                                  let loginPageView = mainStoryboard.instantiateViewController(withIdentifier: "UsersViewController") as! UsersViewController
