...
class FUser {
    ...
    init(_objectId: String, _pushId: String?, _createdAt: Date, _updatedAt: Date, _email: String, _firstname: String, _lastname: String, _avatar: String = "", _loginMethod: String, _phoneNumber: String, _city: String, _country: String, _userName: String) {
    ...
    init(_dictionary: NSDictionary) {
        ...
        if let username = _dictionary[kUSERNAME] {
...
//        return "HShuo5mjx4Pe1cdxvLDMs8Oghym2"
    ...
    class func registerUserWith(email: String, password: String, firstName: String, lastName: String, avatar: String = "", userName: String, completion: @escaping (_ error: Error?) -> Void ) {
        ...
        Auth.auth().createUser(withEmail: userName, password: password, completion: { (firuser, error) in
            ...
            let fUser = FUser(_objectId: firuser!.user.uid, _pushId: "", _createdAt: Date(), _updatedAt: Date(), _email: firuser!.user.email!, _firstname: firstName, _lastname: lastName, _avatar: avatar, _loginMethod: kEMAIL, _phoneNumber: "", _city: "", _country: "", _userName: userName)
        ...
        Auth.auth().signIn(with: credential) { (firuser, error) in
            ...
            fetchCurrentUserFromFirestore(userId: firuser!.user.uid, completion: { (user) in
                ...
                if user != nil && user!.firstname != "" {
                    ...
                    let fUser = FUser(_objectId: firuser!.user.uid, _pushId: "", _createdAt: Date(), _updatedAt: Date(), _email: "", _firstname: "", _lastname: "", _avatar: "", _loginMethod: kPHONE, _phoneNumber: firuser!.user.phoneNumber!, _city: "", _country: "", _userName: kUSERNAME)
