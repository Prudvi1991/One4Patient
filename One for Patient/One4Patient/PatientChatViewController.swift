...
//  One for Patient
//
//  Created by Praneeth Althuru on 01/10/19.
...
@available(iOS 13.0, *)
class PatientChatViewController: JSQMessagesViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, IQAudioRecorderViewControllerDelegate {
...
//        self.inputToolbar = UIEdgeInsets(top: 0, left: 0, bottom: 44, right: 0)
    ...
    override func viewDidLoad() {
        ...
        inputToolbar?.contentView?.rightBarButtonItem?.isEnabled = true;        navigationItem.largeTitleDisplayMode = .never
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView!, avatarImageDataForItemAt indexPath: IndexPath!) -> JSQMessageAvatarImageDataSource! {
        ...
        if let testAvatar = jsqAvatarDictionary!.object(forKey: message.senderId as Any) {
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView!, didTapMessageBubbleAt indexPath: IndexPath!) {
        ...
        case kPICTURE:
            ...
            let photos = IDMPhoto.photos(withImages: [mediaItem.image as Any])
